...
async def save_report(state: FinancialAnalystState):
    ...
    try:
        ...
        report_content = f"""# 📊 AI Financial Analyst Report
...
| **Long Entry?** | {"✅ Yes" if state.technical_data.get("longentry") else "❌ No"} |
| **Short Entry?** | {"✅ Yes" if state.technical_data.get("shortentry") else "❌ No"} |
